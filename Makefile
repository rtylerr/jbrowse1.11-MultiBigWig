...
#     LICENSE => q[perl]
#     NAME => q[JBrowse]
#     PREREQ_PM => { Capture::Tiny=>q[0], Pod::Usage=>q[0], Storable=>q[0], JSON::XS=>q[0], PerlIO::gzip=>q[0], List::Util=>q[0], File::Path=>q[2], Digest::Crc32=>q[0], local::lib=>q[0], DBI=>q[0], Bio::FeatureIO=>q[0], warnings=>q[0], base=>q[0], Getopt::Long=>q[0], IO::File=>q[0], Bio::Index::Fasta=>q[0], Data::Dumper=>q[0], DB_File=>q[0], Bio::Root::Version=>q[1.006000], Bio::Annotation::SimpleValue=>q[0], vars=>q[0], Parse::RecDescent=>q[0], Test::More=>q[0], strict=>q[0], File::Temp=>q[0], File::Copy::Recursive=>q[0], Scalar::Util=>q[0], DBD::SQLite=>q[0], URI::Escape=>q[0], FindBin=>q[0], Fcntl=>q[0], File::Spec=>q[0], Heap::Simple=>q[0], Heap::Simple::XS=>q[0], POSIX=>q[0], Devel::Size=>q[0], File::Spec::Functions=>q[0], Bio::SeqFeature::Lite=>q[0], Bio::GFF3::LowLevel::Parser=>q[1.8], IO::Uncompress::Gunzip=>q[0], Hash::Merge=>q[0], constant=>q[0], Bio::OntologyIO=>q[0], Exporter=>q[0], Bio::SeqFeature::Annotated=>q[0], Carp=>q[0], Test::Warn=>q[0], File::Next=>q[0], JSON=>q[2], File::Basename=>q[0], Cwd=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[dev]
#     test => { TESTS=>q[t/*.t] }
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /var/www/html/jbrowse1.11/extlib
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /var/www/html/jbrowse1.11/extlib/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.86
MM_REVISION = 68600
